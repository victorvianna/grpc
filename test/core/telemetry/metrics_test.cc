...
TEST_F(MetricsTest, Int64CallbackGauge) {
  ...
  ABSL_LOG(INFO) << "testing callbacks for: plugin1";
  ...
  ABSL_LOG(INFO) << "testing callbacks for: plugin1, plugin2";
  ...
  ABSL_LOG(INFO) << "testing callbacks for: plugin1, plugin2, plugin3";
